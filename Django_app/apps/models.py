...
class Message(models.Model):
    ...
    rolling_paper_board = models.ForeignKey(RollingPaperBoard, on_delete=models.CASCADE, related_name='return_board_message_set')
    return_board = models.ForeignKey(RollingPaperBoard, null=True, on_delete=models.SET_NULL, related_name='rolling_paper_board_message_set')
